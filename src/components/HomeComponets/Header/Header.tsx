        ...
        <Fragment>
            <div className="bg-white shadow-lg header">
                <div className="container mx-auto flex justify-between items-center containermargin px-4 py-4">
                    ...
                    <nav className={`flex flex-col lg:flex-row ${isOpen ? 'nav-menu active' : 'nav-menu'}`}>
                    ...
                    {!isOpen && (
                        <>
                            ...
                            <a
                                href="/"
                                className={`rounded px-4 py-1 text-sm transition-colors duration-300 ${activo === "ES" ? "bg-black text-white font-bold" : ""
                                    }`}
                            ...
                            <a
                                href="/en"
                                className={`rounded px-4 py-1 text-sm transition-colors duration-300 ${activo === "EN" ? "bg-black text-white" : ""
                                    }`}
