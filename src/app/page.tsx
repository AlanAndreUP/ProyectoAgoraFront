          ...
          <main>
            <section className="pt-20 pb-10">
              <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="col-span-1 mt-4  flex justify-end inline-block md:mt-0 md:flex md:items-center">
                  <p className="TextColor mr-2 font-bold  md:ml-2 inline-block">Conocer más sobre nuestros programas</p>
            ...
            <section className="pt-20 pb-10">
              <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="col-span-1 mt-4  flex justify-end inline-block md:mt-0 md:flex md:items-center">
                  ...
                  <p className="TextColor mr-2 font-bold md:ml-2 inline-block">Súmate como aliado</p>
                  <img className="w-6 h-6 inline-block" src="/flecha.svg" alt="Icono" />
                </div>
              </div>
